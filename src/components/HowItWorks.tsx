...
const HowItWorks = () => {
  return (
    <section id="how" className="py-32 bg-[#F8FAFC] dark:bg-[#0b1220]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative">
          ...
          {steps.map((step, i) => (
            <div key={i} className="flex flex-col items-center text-center group">
              <div className={`w-24 h-24 ${step.bg} ${step.color} rounded-[2rem] flex items-center justify-center mb-10 relative bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-premium transition-all duration-500 group-hover:scale-110 group-hover:-translate-y-2 group-hover:shadow-2xl`}>
                <step.icon size={36} />
